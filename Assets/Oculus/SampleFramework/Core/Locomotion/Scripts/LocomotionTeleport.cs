...
public class LocomotionTeleport : MonoBehaviour
{
	...
	private void EnableMotion(bool enableLinear, bool enableRotation)
	{
		...
		GameObject.FindGameObjectWithTag("Player").GetComponent<OVRPlayerController>().EnableLinearMovement = enableLinear;
		GameObject.FindGameObjectWithTag("Player").GetComponent<OVRPlayerController>().EnableRotation = enableRotation;
	}
    ...
    {
		EnableMotion(true,true);
		_teleportDestination.gameObject.SetActive(false);
	}
